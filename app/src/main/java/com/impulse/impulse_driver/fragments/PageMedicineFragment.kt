...
import com.impulse.impulse_driver.activity.HistoryActivity
      ...
      private fun initViews() {
          ...
          binding.apply {
              ...
              subscriberViewModel.message.observe(requireActivity(), Observer {
                  ...
                  stopServiceFunc()
                  subscriberViewModel.saveDatabaseFragment(ARG)
          ...
          binding.apply {
              val mTextWatcher = object : TextWatcher {
                  ...
                  override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                      ARG.MEDICINE = NewBase(add_info = etAddInfo.text.toString(), add_infoSecond = etAddInfoSecond.text.toString())
                  }
              }
              etAddInfo.addTextChangedListener(mTextWatcher)
              etAddInfoSecond.addTextChangedListener(mTextWatcher)
          }
      }
