package com.impulse.impulse_driver.service
...
class LocationService : Service() {
    ...
    public var locationCallback: LocationCallback = object : LocationCallback() {
        override fun onLocationResult(locationResult: LocationResult) {
            ...
            if (locationList.isNotEmpty()) {
                ...
                val myLocation = MyLocation("success",latitude = location.latitude,longitude = location.longitude)
                dbRef = FirebaseDatabase.getInstance().getReference("driver_points")
                CoroutineScope(Dispatchers.IO).launch{
                    Log.d("TAG", "initViews: dsadasd")
                    dbRef?.setValue(myLocation)
                }
